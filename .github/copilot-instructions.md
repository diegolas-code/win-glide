...
2. **Step Tracking:** After completing each logical step or sub-task, update the `TODO.md` file (mark tasks as complete) and the `pause.md` file (summarize progress and update next steps).
